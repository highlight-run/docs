...
The version of your current deployment. This is the same version string your provide as `version` to [H.init()](/sdk/client#Hinit). This ensures that we're always using the same set of sourcemaps for your current bundle. The default value is the current Git hash.
