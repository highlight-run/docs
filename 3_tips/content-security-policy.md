...
2.  `worker-src`: `https://static.highlight.io`
...
<meta
	...
	content="default-src 'self'; script-src 'self' https://static.highlight.io; worker-src: https://static.highlight.io; connect-src https://pub.highlight.run;"
/>
```
